            ...
            <section id="latest-blog" className="padding-large">
                ...
                <div className="row">
                    ...
                    <div className="col-lg-4 col-sm-12">
                        ...
                        <h3 className="card-title">
                            <a href="#">Technology Hack You Win Get</a>
                        </h3>
                        </div>
                    </div>
                    <div className="col-lg-4 col-sm-12">
                    ...
                    <div className="swiper testimonial-swiper">
                        ...
                        <div className="swiper-slide text-center d-flex justify-content-center">
                            ...
                            <blockquote>
                                ...
                                morbi sagittis lorem habi mattis Pellen tesque pretium
                                feugiat vel morbi suspen dise sagittis lorem habi tasse
                                morbi.”
                            </blockquote>
                        ...
                        <div className="swiper-slide text-center d-flex justify-content-center">
                            ...
                            <blockquote>
                                ...
                                website or exist independently. A blog may include articles,
                                short posts, listicles, infographics, videos, and other
                                digital content.”
                            </blockquote>
                            <div className="rating">
                                <svg className="star star-fill">
